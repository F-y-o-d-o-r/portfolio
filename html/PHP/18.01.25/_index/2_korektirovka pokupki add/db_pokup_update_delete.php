...
<span style="color:teal; font-weight:bold; font-size:11pt;">Откорректировать</span><span style="color:teal; font-weight:normal; font-size:11pt;"> или </span><span style="font-weight:bold;">удалить</span> <span style="font-weight:normal;">покупку.</span>
...
<br>
<input type="button" style="background-color:whitesmoke;" name="pokup_update" value="Изменить" onclick="pokup_update_prover(this.name);">
<input type="button" style="background-color:whitesmoke;" name="pokup_delete" value="Удалить" onclick="pokup_delete_go(this.name);">
