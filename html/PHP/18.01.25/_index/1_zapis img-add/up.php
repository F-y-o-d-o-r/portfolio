...
$dir='/home/alexander/www/img/tmp/';
$slll=mt_rand(1,1000);
...
switch($mas['mime']) {
case 'image/jpeg': $photo = imagecreatefromjpeg($source_);
break;
case 'image/gif': $photo = imagecreatefromgif($source_);
break;
case 'image/png': $photo = imagecreatefrompng($source_);
break;
}
