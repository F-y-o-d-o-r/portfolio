...
<div id="languages" style="text-align:right;">
  <form name="form_languages">
    <select name="select_languages" onchange="select_languages_change();">
      <option selected>ru</option>
      <option>ua</option>
    </select>
  </form>
  <script>
    function select_languages_change() {
      jquery_send('#okno', 'post', 'db_poisk.php', ['language'], [form_languages.select_languages.options[form_languages.select_languages.selectedIndex].text]);
    }
  </script>
</div>
...
echo '<ul id="spisok">
<li class="rool" style="color:royalblue; font-weight:bold;" onclick="color_font(this); jquery_send(\'#okno\', \'post\', \'db_poisk.php\', [], []);">Поиск</li><br>
<li class="rool" onclick="color_font(this); jquery_send(\'\', \'post\', \'\', [], []);">Товары</li><br>
<li class="rool" onclick="color_font(this); jquery_send(\'\', \'post\', \'\', [], []);">Клиенты</li><br>
