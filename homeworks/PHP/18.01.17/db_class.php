...
//----------------------------------------------------------
  ...
  {                                               // 17. МЕТОД БАЗОВОГО КЛАССА "ВЫВОД В DOM"
    ...
    if (isset($_POST['name_select']) or isset($_POST['tov_insert']) or isset($_POST['tov_update']) or isset($_POST['tov_delete']) or isset($_POST['klient_insert']) or isset($_POST['klient_update']) or isset($_POST['klient_delete'])) {                                    //ЕСЛИ НАЖАТА КНОПКА "Искать покупку"...
