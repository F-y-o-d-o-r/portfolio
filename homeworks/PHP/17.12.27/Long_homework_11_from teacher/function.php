...
//ВСЕ ЭТО (ВЕСЬ БАЗОВЫЙ КЛАСС) ПОТОМ БУДЕТ МОДЕЛЬЮ...
class LongClasswork
{
...
*/
//ДВА КЛАССА ЗДЕСЬ ЛИШНИЕ - СОБСТВЕННО, ООП(В ДАННОМ СЛУЧАЕ - НАСЛЕДОВАНИЕН) ДЛЯ ЭТОГО И НУЖНО, ЧТОБЫ ОБОЙТИСЬ ОДНИМ КЛАССОМ ДЛЯ РАЗНЫХ СОБЫТИЙ...
