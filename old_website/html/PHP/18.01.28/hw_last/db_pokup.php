...
<div id="pokup">
  ...
  <div id="tovar_korr"
    ...
    <span style="color:teal; font-weight:bold; font-size:11pt;">Добавить новую покупку</span><span
        style="color:teal; font-weight:normal; font-size:11pt;"> - выберите <span
          style="font-weight:bold;">клиента</span>, <span style="font-weight:bold;">товар</span> и <span
          style="font-weight:bold;">дату</span></span>
...
<br>
<div id="maska" style="width:70px; height:22px; position:absolute; z-index:1;" onmouseover="pokup_insert_naved();"
     onmouseout="pokup_error.innerHTML='&nbsp';;">
</div>
<input type="button" style="background-color:silver;" name="pokup_insert" value="Добавить"
       onclick="pokup_insert_go(this.name);">
