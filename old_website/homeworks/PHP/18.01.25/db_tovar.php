...
<div id="tovar">
  ...
  <div id="tovar_korr"
    ...
    <form style="margin:0px;">
      ...
      "display:table;">
      <div style
      "display:table-raw; height:75px;">
      <div style="display:table-cell; width:315px; height:75px; float:left;">
        <input type="text" maxlength="50" style="background-color:silver; width:300px;" name="tov_pole"
...
<div style="display:table-cell; width:75px; padding-left:15px;">
  <div style="position:relative; width:75px; height:16px;">
    <div
        style="position:absolute; width:75px; height:16px; border:1px solid silver; border-radius:4px; z-index:0; text-align:center; background-color:teal; color:white; font-size:8pt; font-family:arial;">
