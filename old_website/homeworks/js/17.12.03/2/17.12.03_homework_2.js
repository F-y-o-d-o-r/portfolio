 ...
 */
//2.Замените :
//-все js-метод …style…, setAttribute(getAttribute) на необходимые jq-методы;
//-конструкцию :
//var el_tbody=document.getElementById("tbody");
//while(el_tbody.childNodes.length) {el_tbody.removeChild(el_tbody.childNodes[0]);}
//на необходимый(мые) jq-метод(ы);
//-конструкцию :
