...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      // GSAPEase: path.resolve('node_modules', 'gsap/src/minified/easing/EasePack.min.js'),
      // GSAPEasePlagin: path.resolve('node_modules', 'gsap/src/minified/plugins/EaselPlugin.min.js')
    },
    plugins: [
